...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AnalyzeCSV_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AnalyzeCSV_t qt_meta_stringdata_AnalyzeCSV = {
    {
QT_MOC_LITERAL(0, 0, 10), // "AnalyzeCSV"
QT_MOC_LITERAL(1, 11, 21), // "on_verify_btn_clicked"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "AnalyzeCSV\0on_verify_btn_clicked\0"
};
...
void *AnalyzeCSV::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AnalyzeCSV.stringdata))
