...
ui(new Ui::AnalyzeCSV)
{
    ...
    You may want to verify the names of the actual objects being populated on the csv.ui form
    ...
    ui(new Ui::AnalyzeCSV)
{
    ...
    // Include domain label stuff here
...
// This function is auto-generated by QT, will regenerate publication data
...
void AnalyzeCSV::populate_presentation_tree()
{
  ...
  //  p_treeNew->populate_for_publications(_data, (int)s,(int)e);
    ...
    pr_treeNew->populate_for_presentations(pr_data,0, 4000);
    ...
    // As soon as Analyze is registered, information is displayed..
...
// Jerry this is called when the filter button on the Presentation page is clicked
