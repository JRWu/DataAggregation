...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        verticalLayoutWidget->setGeometry(QRect(210, 110, 341, 354));
        verticalLayout = new QVBoxLayout(verticalLayoutWidget);
        verticalLayout->setSpacing(6);
        verticalLayout->setContentsMargins(11, 11, 11, 11);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        logo_lbl = new QLabel(verticalLayoutWidget);
        logo_lbl->setObjectName(QStringLiteral("logo_lbl"));
        logo_lbl->setMinimumSize(QSize(300, 300));
        logo_lbl->setPixmap(QPixmap(QString::fromUtf8("apple.jpg")));
        logo_lbl->setScaledContents(true);
        logo_lbl->setAlignment(Qt::AlignCenter);

        verticalLayout->addWidget(logo_lbl);

        open_program = new QPushButton(verticalLayoutWidget);
        open_program->setObjectName(QStringLiteral("open_program"));
        QFont font;
        font.setFamily(QStringLiteral("Arial Black"));
        font.setPointSize(20);
        font.setBold(true);
        font.setWeight(75);
        open_program->setFont(font);
        open_program->setFlat(true);

        verticalLayout->addWidget(open_program);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        open_program->setText(QApplication::translate("MainWindow", "Apple Picker", 0));
