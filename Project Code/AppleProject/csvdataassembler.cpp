...
{
    string h[] = {"Member Name","Primary Domain","Start Date","End Date", "Funding Type","Status", "Peer Reviewed?","Industry Grant?", "Role", "Title", "Principal Investigator", "Co-Investigators", "Total Amount",
        
        "Short Title", "Application Summary", "Grant Purpose", "Area", "Grand and/or Account #", "Prorated Amount", "Administered By", "Funding Source", "Project", "Currency", "Received Amount", "Member Share", "Monetary", "Reportable", "Hours Per Week", "Personnel Paid", "Rnw", "Education Grant", "Duplicate Reported"
    };
