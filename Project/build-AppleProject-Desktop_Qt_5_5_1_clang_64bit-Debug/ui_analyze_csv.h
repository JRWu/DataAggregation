...
public:
    ...
    void setupUi(QMainWindow *AnalyzeCSV)
    {
        ...
        horizontalLayoutWidget_2->setGeometry(QRect(10, 10, 741, 481));
        ...
        present_tab->setPalette(palette5);
...
#endif // QT_NO_ACCESSIBILITY
        plainTextEdit->setPlainText(QApplication::translate("AnalyzeCSV", "This is page 1\n"
"\n"
"\n"
"\n"
"\n"
...
"Hey", 0));
        ...
        plainTextEdit_2->setPlainText(QApplication::translate("AnalyzeCSV", "This is page 2 of the collapsable menu\n"
"\n"
"Hey", 0));
        toolBox->setItemText(toolBox->indexOf(page_2), QApplication::translate("AnalyzeCSV", "Page 2", 0));
        plainTextEdit_3->setPlainText(QApplication::translate("AnalyzeCSV", "This is page 3 of the collapsable menu\n"
"\n"
"Hey", 0));
        toolBox->setItemText(toolBox->indexOf(page_3), QApplication::translate("AnalyzeCSV", "Page 3", 0));
        plainTextEdit_4->setPlainText(QApplication::translate("AnalyzeCSV", "This is page 4 of the collapsable menu\n"
"\n"
"Hey", 0));
