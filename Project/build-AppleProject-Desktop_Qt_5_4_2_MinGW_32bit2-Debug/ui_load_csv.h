...
public:
    ...
    void retranslateUi(QMainWindow *LoadCSV)
    {
        ...
        load_label->setText(QApplication::translate("LoadCSV", "<html><head/><body><p><span style=\" font-size:28pt; font-weight:600; color:#d30000;\">LOAD &gt;</span></p></body></html>", 0));
        verify_label->setText(QApplication::translate("LoadCSV", "<html><head/><body><p><span style=\" font-size:28pt; font-weight:600; color:#aaaa7f;\">VERIFY &gt;</span></p></body></html>", 0));
        analyze_label->setText(QApplication::translate("LoadCSV", "<html><head/><body><p><span style=\" font-size:28pt; font-weight:600; color:#aaaa7f;\">ANALYZE &gt;</span></p></body></html>", 0));
    } // retranslateUi
